...
var stop = function () { }; // unsubscribe placeholder
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            stop = db.collection('entitlements')
                ...
                if (!snap.exists)
                    return;
                var _a = snap.data().ids, ids = _a === void 0 ? [] : _a;
                ids.forEach(function (id) {
                    // url rule: you already store SKU → image somewhere ↓
                    var url = "https://cdn.my\u2011stickers.com/".concat(id, ".png");
                    overlay.createOverlay('auto-' + id, url);
                });
            }, function (err) { return console.error('🔥 Firestore watch error', err); });
            return [2 /*return*/];
        });
    });
}
function unwatch() { stop(); }
