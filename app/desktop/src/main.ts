...
async function createWindow() {
  mainWin = new BrowserWindow({
    ...
    height: 800,
    webPreferences: {
      // Use a __dirname-relative path for the preload script. `__dirname` will
      // be `app/desktop/dist` in both dev and prod, which is correct.
  ...
  if (app.isPackaged) {
    ...
    // Using loadFile is simpler and more robust for local files.
